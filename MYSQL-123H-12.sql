...
-- voltar para innodb LEMBRE-SE. Senão dá lock table. mesmo se for apenas uma tabela, bloqueia outras tabelas. BKP sempre
...
OBS: SE TIVESSE UM PROBLEMA GENERALIZADO EM TODAS AS TABELAS DO BANCO CLIENTE2
mysqlcheck -r --databases CLIENTE2 -u root -p

OU EM TODAS AS TABELAS DE TODAS AS BASES DE DADOS
